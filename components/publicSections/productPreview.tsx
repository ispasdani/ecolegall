...
const ProductPreview = (): React.ReactElement => {
  return (
    <div className="w-full flex flex-col relative items-center justify-center">
      <motion.div
        className="relative mt-28 md:p-24 p-4 bg-gradient-to-b from-[#25a18e] md:rounded-[32px] rounded-[12px]"
      ...
      >
        ...
        <Image
          src={"/assets/productLanding.webp"}
          alt="preview image"
          width={1200}
          height={951}
        />
