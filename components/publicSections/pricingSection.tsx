    ...
    <div className="w-full flex items-center justify-center">
      <div className="w-full flex flex-col lg:flex-row lg:flex items-center justify-center  space-x-0 lg:space-x-10 space-y-10 lg:space-y-0">
        ...
        <motion.div
          ...
          //   ease: "easeInOut",
          // }}
          className="relative h-[1050px] w-full my-16 md:my-0 bg-[#25a18e] rounded-3xl p-6 lg:p-8 xl:p-16 border shadow-[0px_10px_23px_0px_#0000001a,0px_41px_41px_0px_#00000017,0px_92px_55px_0px_#0000000d,0px_164px_66px_0px_#00000003,0px_257px_72px_0px_#00000000]"
        >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary"
          ? "bg-gradient-to-b border border-emerald-700 from-emerald-500 to-[#25a18e] text-white"
          : "bg-white",
        className
      )}
    >
