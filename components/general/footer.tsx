...
import PaperPinCard from "./paperPin";
...
const Footer = () => {
  return (
    <div className="md:h-[683px] h-[200%] p-4 pb-0 relative rounded-[35px] border border-[#E6E6E6] mt-5 mb-11 overflow-hidden flex flex-col justify-between">
      <div
      ...
      />{" "}
      <PaperPinCard className="absolute hidden xl:block -bottom-44 -left-36 md:-bottom-40 md:-left-20 md:z-10 -z-10 rotate-[20deg] md:[&>*]:scale-100 [&>*]:scale-50" />
